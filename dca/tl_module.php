...
$arrPalettes = [
    \HeimrichHannot\PinBoard\PinBoard::MODULE_PINBOARD        => '{title_legend},name,headline,type;'
                                                                 ...
                                                                 . 'addCreateButton,jumpToDetails,addEditCol,addPublishCol,addDeleteCol;{security_legend},deactivateTokens;'
    ...
    \HeimrichHannot\PinBoard\PinBoard::MODULE_PINBOARD_EDITOR => '{title_legend},name,headline,type;'
                                                                 . '{entity_legend},formHybridEditable;{security_legend},disableSessionCheck,disableAuthorCheck,addUpdateConditions,addDeleteConditions,deactivateTokens;'
                                                                 . '{email_legend},formHybridSendSubmissionViaEmail;'
                                                                 . '{redirect_legend},jumpTo;{misc_legend},defaultArchive,formHybridAddDefaultValues,setPageTitle,formHybridAsync;'
